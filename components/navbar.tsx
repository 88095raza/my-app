...
interface NavbarProps {
    ...
    scrollToShopifyDesign: ()=> void
    scrollToBrandsDesign: ()=> void
}

const Navbar = ({
    scrollToWebsiteDesign,
    scrollToGraphicDesign,
    scrollToShopifyDesign,
    scrollToBrandsDesign,
    // Add scrollToServices to props
  }: NavbarProps) => {
    ...
    <div >
          <div className="p-6 md:p-10 flex items-center justify-between
           z-50">
            ...
            items-center text-slate-300 text-center bg-clip-text 
            bg-transparent bg-gradient-to-b from-neutral-50 to
            ...
            <div onClick={scrollToShopifyDesign} className="hover:text-gray-50"> shopify Stores</div>
            <div onClick={scrollToBrandsDesign} className="hover:text-gray-50"> Brands</div> 
